...
function CraftPage() {
  return <main className="craft-page" data-section="craft-page">
    <section className="craft-page-hero"><div><p className="eyebrow">THE ILLUSION, EXPLAINED</p><h1>Looks forged.<br/><em>Breaks beautifully.</em></h1><p>Every piece is hand-cast to fool the eye, then made to reward the first bite.</p></div><img src={asset('chocolate-gift.jpg')} alt="Chocolate tool gift set" /></section>
    ...
    <section className="craft-promise"><img src={asset('hero-toolbox.jpg')} alt="Chocolate gift box detail" /><div><p className="eyebrow">SERIOUSLY GOOD CHOCOLATE</p><h2>The reveal is only<br/><em>the beginning.</em></h2><p>Behind the illusion is a proper cacao snap: balanced, rich and genuinely delicious.</p></div></section>
  </main>;
}
